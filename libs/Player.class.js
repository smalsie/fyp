...
function Player(startX, startY, game, spriteSheet, spriteX, spriteY) {
	...
	*/
	...
	/**
	* Sets if the player should have gravity that will cause them to fall to the ground
	*
	* @param {boolean} gravity true or false value denoting whether 
	* the player should have gravity. If true the player will 
	* fall to the ground, if false the player will not.
	*/
